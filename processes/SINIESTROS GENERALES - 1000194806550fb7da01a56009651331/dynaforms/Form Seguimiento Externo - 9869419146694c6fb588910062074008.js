...
function mostrar_documentos(){
  $('#75872951966b05281f36106009080175').show(); // *** Documentos de respaspaldo
  }
function mostrar_historial(){
  $('#7403890606552d71dbfcce0019230087').show(); // ** Historial de casos 
  }
function ocultar_documentos(){
  $('#75872951966b05281f36106009080175').hide(); // *** Documentos de respaspaldo
  }
...
let nro_stro = $('#tri_nro_stro').getValue();
if(nro_stro == '' ){
  $('#nro_stro').hide();
  $('#nro_inspeccion').hide(); 
}
