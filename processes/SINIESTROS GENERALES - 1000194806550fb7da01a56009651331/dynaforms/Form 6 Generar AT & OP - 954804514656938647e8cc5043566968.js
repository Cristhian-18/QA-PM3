...
$('#18277194465787f6590bb75083746853').show(); // Poliza
$('#85476718465808581bb3ea0055272944').show(); // datos bancarios
$('#subtitleDatase').show();
...
function ocultar_solicitud(){
    ...
    $('#18277194465787f6590bb75083746853').hide();
  	$('#85476718465808581bb3ea0055272944').hide();
    $('#subtitleDatase').hide();
...
function accion(newValue, oldValue) {+
    ...
    $('#frm_num_at').hide(); 
    $('#frm_num_at').disableValidation();
    $('#frm_num_op').hide();
    $('#frm_num_op').disableValidation(); 

  if(newValue == 'FINALIZAR'){
    $('#frm_num_at').show(); 
    $('#frm_num_at').enableValidation();
    $('#frm_num_op').show();
    $('#frm_num_op').enableValidation(); 
  }
