...
$('#frm_as_valorTotal').hide();
$('#frm_as_valorDeducible').hide();
$('#frm_as_valorDepreciacion').hide();
$('#frm_as_valorInfraseguros').hide();
$('#frm_as_reclamoTieneCobertura').hide();
$('#frm_as_reclamoSuperaDeducible').hide();
$('#frm_as_generarCartaNegativa').hide();
$('#frm_fechaUltimoDocumento').hide();*/
...
$('#18277194465787f6590bb75083746853').show(); // Atención al caso
$('#subtitleDatase').show();
...
function accion(newValue, oldValue) {
    ...
    if (newValue == 'CONTINUAR') {
        $('#3524701026552e2db3b1ce7038906501').show();
    }
}
