...
$('#27940000565e5589d798841016410751').disableValidation();
...
function accionEquisuiza(newValue, oldValue) {
  //tri_usr_analista
  $("#tri_usr_analista").hide();
...
accionEquisuiza($("#frm_accion").getValue(), '');
$("#frm_accion").setOnchange(accionEquisuiza);
