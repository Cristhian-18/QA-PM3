$('#frm_cartaDeducible').hide();
$('#frm_cartaDeducible').disableValidation();
...
function action(newVal, oldVal) {
  ...
  $('#frm_cartaDeducible').disableValidation();
    ...
    if (newVal == 'CONTINUAR'){
       $('#frm_cartaDeducible').show();
       $('#frm_cartaDeducible').enableValidation();
    } 
...
$('.menu').on('click', function () {
  ...
  function ocultar_todo() {
    ...
    $('#78166437265657eea8bf0e4033789844').hide()
  ...
  function mostrar_solicitud() {
    ...
    $('#78166437265657eea8bf0e4033789844').show()
}
