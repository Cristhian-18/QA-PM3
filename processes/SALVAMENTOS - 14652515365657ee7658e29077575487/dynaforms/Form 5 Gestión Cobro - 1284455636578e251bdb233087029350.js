...
function action(newVal, oldVal) {
  ...
  $("#frm_cobro_fechaEntregaActaRecepcion").hide();
    $("#frm_cobro_fechaEntregaActaRecepcion").disableValidation();
    $("#file_entrega").hide();
    $("#file_entrega").disableValidation();
  ...
  $("#frm_cobro_fechaEntregaActaRecepcion").show();
    $("#frm_cobro_fechaEntregaActaRecepcion").enableValidation();
    $("#file_entrega").show();
    $("#file_entrega").enableValidation();
...
jQuery("#grd_registro_pagos").onAddRow(function (row, grid, index) {
    console.log("add row")
    console.log(index)
    $("#grd_registro_pagos").getControl(index,9).attr('disabled', true);
