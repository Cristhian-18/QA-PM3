...
$(".form-control").css({"box-shadow":"none","border":"1px solid #e0e0e0","border-radius":"6px","background":"#fafafa","color":"#333"});
...
// ── BOTÓN DANGER (reasignado a verde) ────────────────────────
...
// ── DIALOGS UI ───────────────────────────────────────────────
$(".ui-dialog-titlebar").css({"background-color":"#008E78","color":"#DFFFCE"});
$(".ui-button").css({"background-color":"#008E78","color":"#ffffff","border-radius":"6px"});
