...
*/
/*
$("#tri_id_stro").setValue("2249 - 2025");
$("#tri_nro_stro").setValue("42244242");
*/
$("#id-stro").html(''+$("#tri_id_stro").getValue());
if($("#tri_id_stro").getValue() == ''){
    $("#id-stro").html(''+$("#nro_inspeccion").getValue());
}

$("#nro-stro").html(''+$("#tri_nro_stro").getValue());
if($("#tri_nro_stro").getValue() == ''){
    $("#nro-stro").html(''+$("#id_stro_insp").getValue());
}
