...
if(@@app_padre_totales == '' || @@app_padre_totales == null){
	return;
}

$newCaseId = @@app_padre_totales;
$c = new Cases();
...
@@id_stro= $aCase['APP_DATA']['id_stro'];
@@nro_inspeccion= $aCase['APP_DATA']['nro_inspeccion'];
@@id_stro_insp = $aCase['APP_DATA']['id_stro_insp'];

echo ("ACCION uid_padre");
echo (@@frm_accion);
