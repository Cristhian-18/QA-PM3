...
/*var grd_beneficiario_contingente = $("#grid_beneficiarios_contingentes").getNumberRows();
if (grd_beneficiario_contingente == 1) {
  var grd_beneficiario_1_cont = $("#grid_beneficiarios_contingentes").getValue(1, 3);
  if (grd_beneficiario_1_cont == '') {
    $("#grid_beneficiarios_contingentes").hide();
    $("#frm_plan_total_beneficiarios_contingentes").hide();
  }
}

var grd_beneficiario = $("#grd_beneficiario").getNumberRows();
if (grd_beneficiario == 1) {
  var grd_beneficiario_1 = $("#grd_beneficiario").getValue(1, 2);
  if (grd_beneficiario_1 == '') {
