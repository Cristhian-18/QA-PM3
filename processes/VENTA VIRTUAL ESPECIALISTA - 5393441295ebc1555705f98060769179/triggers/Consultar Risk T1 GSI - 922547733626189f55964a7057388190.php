...
$nombre1 = @@frm_primer_nombre;
$nombre2 = @@frm_segundo_nombre;
$apellido1 = @@frm_apellido_paterno;
$apellido2 = @@frm_apellido_materno;
$cedulaCliente = @@frm_numero_identificacion;
...
@@tmp_cli = '{
    "sUSERCODE": "'.$sUserCode.'",
    "sDocId":"'.$cedulaCliente.'",
    "sNom1":"'.$nombre1.'",
    "sNom2":"'.$nombre2.'",
    "sApe1":"'.$apellido1.'",
    "sApe2":"'.$apellido2.'",
    "sOrigen":"BPM_Especialista",
    "bEnviarEmailCumplimiento": false,
    "cod_Aseg": 0,
    "sFiguraPersona": "ASEGURADO",
