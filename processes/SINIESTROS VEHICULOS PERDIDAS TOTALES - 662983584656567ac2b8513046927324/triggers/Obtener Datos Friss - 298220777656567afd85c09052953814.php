...
$sql_frizz_url = "SELECT DESCRIPCION FROM ADMIN_CATALOGOS WHERE CODIGO = 'Consulta_Friss'";
...
$sql_auth_frizz = "SELECT VALOR FROM ADMIN_CATALOGOS WHERE CODIGO = 'FRIZZ_BEARER'";
