...
if (@@tri_bandera_primera_extraccion == "1") {
	return;
}
...
//paso de qa
@@id_stro  = $aCase['APP_DATA']['nro_stro'];
@@frm_poliza_codSucursal = $aCase['APP_DATA']['frm_poliza_codSucursal'];
@@frm_cobertura_aplicada = $aCase['APP_DATA']['frm_cobertura_aplicada'];
...
@@frm_codAgente  = $aCase['APP_DATA']['frm_codAgente'];
...
@@tri_correo_cliente = $aCase['APP_DATA']['frm_correo_cliente'];
...
@@tri_bandera_primera_extraccion = "1";
