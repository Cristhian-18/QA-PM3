...
function action(newVal, oldVal) {
    ...
    $("#frm_INVEC_valorInsoluto_final").enableValidation();
    $("#frm_INVEC_fechaPago_final").enableValidation();
    $("#file_pagoParcial").enableValidation();
    $("#frm_numAT_final").enableValidation();
      $("#file_pagoTotal").enableValidation();

    $("#frm_numOP_final").enableValidation();

    if (newVal == 'REGISTRAR') {
        $("#frm_INVEC_valorInsoluto_final").disableValidation();
        $("#frm_INVEC_fechaPago_final").disableValidation();
        $("#file_pagoParcial").disableValidation();
        $("#frm_numAT_final").disableValidation();
        $("#frm_numOP_final").disableValidation();
            $("#file_pagoTotal").disableValidation();
