$("#frm_AT").hide();
$("#frm_AT").disableValidation();

$("#frm_valores_valorCasco").getControl().attr('disabled', true);
$("#frm_valores_extras").getControl().attr('disabled', true);
function action(newVal, oldVal) {
    $("#frm_AT").hide();
    $("#frm_AT").disableValidation();

    $("#fle_finiquito").hide();
   $("#fle_finiquito").disableValidation();
    $("#frm_OP").hide();
  $("#frm_OP").disableValidation();

    if (newVal == 'CONTINUAR') {
        $("#frm_AT").show();
        $("#frm_AT").enableValidation();
        $("#fle_finiquito").show();
      $("#fle_finiquito").enableValidation();
        $("#frm_OP").show();
      $("#frm_OP").enableValidation();
    }
