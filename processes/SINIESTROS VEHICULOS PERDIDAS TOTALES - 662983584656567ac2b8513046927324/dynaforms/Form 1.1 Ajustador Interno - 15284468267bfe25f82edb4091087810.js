...
$("#frm_valoresAprobados_valoresRepuestos1").getControl().attr('disabled', false);
$("#frm_valoresAprobados_procentajeDescuentoProformado").getControl().attr('disabled', false);
$("#frm_valoresAprobados_manoObraProformada").getControl().attr('disabled', false);
$("#frm_valoresAprobados_diasEstimadosReparacion").getControl().attr('disabled', false);
...
function action(newVal, oldVal) {
    ...
    $("#file_poliza").disableValidation();
    $("#file_documentoOpcional").hide();
    $("#frm_checkbox_documentos").disableValidation();
    $("#frm_checkbox_documentos").hide();
    $("#frm_documentos_check").disableValidation();
    $("#413499516656567afcedb62004747135").hide();
 $("#tri_correo_cliente").hide();


    if (newVal == 'CONTINUAR') {
        $("#frm_checkbox_documentos").enableValidation();
        $("#frm_checkbox_documentos").show();
        $("#frm_documentos_check").enableValidation();

    }
   if (newVal == 'ADJUNTAR') {
        $("#tri_correo_cliente").show();
