...
function action(newVal, oldVal) {
    //frm_INVEC_valorInsoluto
    //frm_INVEC_fechaPago
    //file_pagoParcial
    //frm_numAT
    //frm_numOP
    $("#frm_INVEC_valorInsoluto").enableValidation();
    $("#frm_INVEC_fechaPago").enableValidation();
    $("#file_pagoParcial").enableValidation();
    $("#frm_numAT").enableValidation();
    $("#frm_numOP").enableValidation();

    if (newVal == 'REGISTRAR') {
        $("#frm_INVEC_valorInsoluto").disableValidation();
        $("#frm_INVEC_fechaPago").disableValidation();
        $("#file_pagoParcial").disableValidation();
        $("#frm_numAT").disableValidation();
        $("#frm_numOP").disableValidation();
    } 
