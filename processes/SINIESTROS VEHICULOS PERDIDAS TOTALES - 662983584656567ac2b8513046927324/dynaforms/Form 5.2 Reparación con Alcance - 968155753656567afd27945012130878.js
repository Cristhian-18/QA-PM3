...
function action(newVal, oldVal) {
  ...
  $('#757847265656567afcfbc37043953030').hide();
  $('#692779228656567afcf3ac6024140413').hide();
  ...
  if (newVal == "SOLICITAR") {
    ...
    if(taller == "MUNDO MOTRIZ" || tipo_taller == "TALLER AUTORIZADO MULTIMARCA"){
      if(pest == 'repuestos'){
        $('#757847265656567afcfbc37043953030').show();
        }
      }
    ...
    $('#692779228656567afcf3ac6024140413').show();
  ...
  if (newVal == "CONTINUAR") {
    ...
    $("#462350562656567afd04c63077818887").show();
  }
  if (newVal == "REPUESTOS") {
    $('#frm_comentario_aux').show();
    $('#frm_comentario_aux').enableValidation();
...
function ocultar_todo() {
  $("#btn_anadir").hide();
  $("#757847265656567afcfbc37043953030").hide();
  $("#384439457656567afceab65011611057").hide();
  $("#subt_friss").hide();
  ...
  $("#462350562656567afd04c63077818887").hide();
