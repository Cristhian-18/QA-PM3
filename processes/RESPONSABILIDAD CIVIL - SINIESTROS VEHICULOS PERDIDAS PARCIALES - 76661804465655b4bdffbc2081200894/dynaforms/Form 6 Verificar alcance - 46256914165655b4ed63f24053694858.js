...
function checkValores(newVal, oldVal) {
  ...
  for (let i = 1; i <= numberRows; i++) {
      if ($("#grd_valores_siniestros_alcance").getValue(i, 11) != "Negado") {
          ...
          valorSuma = valorSuma + parseFloat($("#grd_valores_siniestros_alcance").getValue(i, 5));
      }
      valorTotal = valorTotal + parseFloat($("#grd_valores_siniestros_alcance").getValue(i, 5));
...
$('.menu').on('click', function () {
  ...
  function ocultar_todo() {
    ...
    $('#sub_alcances').hide()
    $('#18043158265655b4ed5c352091029762').hide()
  }
  function mostrar_solicitud() {
    ...
    $('#sub_alcances').show()
    $('#18043158265655b4ed5c352091029762').show()
    $('#57719423965655b4ed5e193039723079').show()
