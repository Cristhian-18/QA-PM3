<?php
//RESPONSABILIDAD CIVIL – SINIESTROS VEHICULOS PERDIDAS PARCIALES
//200789 200283
...
FROM certificacion.PMT_PRELIQUIDACION_CIVIL t
...
WHERE t.APP_NUMBER = " . $appNumber . "
  ...
  AND c.CON_LANG = 'es'";
*/
$sql = "SELECT t.*, COALESCE(c.CON_VALUE, 'RESPONSABILIDAD CIVIL - SINIESTROS VEHICULOS PERDIDAS PARCIALES') AS frm_name_process
FROM certificacion.PMT_PRELIQUIDACION_CIVIL t
JOIN APPLICATION a ON a.APP_NUMBER = t.APP_NUMBER
...
/*@=appData = [
    'frm_name_process'                              => isset($rs['1']['frm_name_process'])                                ? $rs['1']['frm_name_process']                                : '',
    'frm_numcaso'                                   => isset($rs['1']['APP_NUMBER'])                                      ? $rs['1']['APP_NUMBER']                                      : '',
    'frm_valoresAprobados_manoObraProformada'       => isset($rs['1']['FRM_VALORESAPROBADOS_MANOOBRAPROFORMADA'])         ? $rs['1']['FRM_VALORESAPROBADOS_MANOOBRAPROFORMADA']         : 0,
    'frm_valoresAprobados_valorRepuestosProformado' => isset($rs['1']['FRM_VALORESAPROBADOS_VALORREPUESTOSPROFORMADO'])   ? $rs['1']['FRM_VALORESAPROBADOS_VALORREPUESTOSPROFORMADO']   : 0,
    'frm_deducible_deducible'                       => isset($rs['1']['FRM_DEDUCIBLE_DEDUCIBLE'])                         ? $rs['1']['FRM_DEDUCIBLE_DEDUCIBLE']                         : 0,
    'frm_deducible_rasa'                            => isset($rs['1']['FRM_DEDUCIBLE_RASA'])                              ? $rs['1']['FRM_DEDUCIBLE_RASA']                              : 0,
    'tri_nro_stro'                                  => isset($rs['1']['TRI_NRO_STRO'])                                    ? $rs['1']['TRI_NRO_STRO']                                    : '',
    'frm_busqueda_nombres'                          => isset($rs['1']['FRM_BUSQUEDA_NOMBRES'])                            ? $rs['1']['FRM_BUSQUEDA_NOMBRES']                            : '',
    'frm_vehiculo_placa'                            => isset($rs['1']['FRM_VEHICULO_PLACA'])                              ? $rs['1']['FRM_VEHICULO_PLACA']                              : '',
    'frm_vehiculo_marca'                            => isset($rs['1']['FRM_VEHICULO_MARCA'])                              ? $rs['1']['FRM_VEHICULO_MARCA']                              : '',
