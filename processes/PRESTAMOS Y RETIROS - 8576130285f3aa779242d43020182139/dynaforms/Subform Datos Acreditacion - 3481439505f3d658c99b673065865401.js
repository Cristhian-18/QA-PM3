$("#frm_cedula_receptor").focusout(function(){
	var bool = validarIdentificacion($('#frm_cedula_receptor ').getValue(), $('#frm_tipo_identificacion_receptor').getControl().val());
	if(bool == false){
		$('#frm_cedula_receptor ').setValue("");
