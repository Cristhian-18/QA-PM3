...
$('#9802986195f3cace465c8e8078214983').hide(); //documentos
$('#13283628860e352dadef162015150841').toggle(); //documentos
$('#3481439505f3d658c99b673065865401').toggle(); //acreditar
$('#4507897025f8ee23ab6d4a0062588371').toggle(); //debitar
$('#2287684385f3ea13a46f6c7064108437').toggle(); //historial


$("#3577505425f3e9021c0c6a8022160594").setOnSubmit(function(){
  $("#3577505425f3e9021c0c6a8022160594").saveForm() ;
...
$("#tabla_amor").html($("#tri_table_amor").getValue()); 
  //console.log($("#tri_table_amor").getValue());
//oculto seccion debito
$('#frm_sbt_debito').hide();
$('#4507897025f8ee23ab6d4a0062588371').hide();
...
$('#frm_numero_cuenta').disableValidation();
  if($('#frm_numero_endozo_vigente').getValue() == ''){
       $('#frm_numero_endozo_vigente').disableValidation();
...
//si es retiro por defecto natural
  ...
  if(newValue == 'P'){
    ...
    //otro subform
    $('#frm_sbt_debito').show();
    $('#4507897025f8ee23ab6d4a0062588371').show();
    $('#4507897025f8ee23ab6d4a0062588371').toggle(); //debitar
...
$("#fle_transferencia").hide();
if($("#tri_bandera_transfer").getValue() == 'true'){
$("#fle_transferencia").show();
}