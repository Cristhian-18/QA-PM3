...
$("#2693844245f3ebe2a4d1241089536305").setOnSubmit(function(){
  $("#2693844245f3ebe2a4d1241089536305").saveForm() ;
...
function mensaje(){
  if($("#tri_mes_GrabarMovPR").getValue() != ''){
    window.dynaform.flashMessage( {
       duration : 8000,
       emphasisMessage: "ERROR: ",
       message:$("#tri_mes_ConsultaPID").getValue()+' '+$("#tri_mes_GrabarMovPR").getValue(),
       type : 'danger',
