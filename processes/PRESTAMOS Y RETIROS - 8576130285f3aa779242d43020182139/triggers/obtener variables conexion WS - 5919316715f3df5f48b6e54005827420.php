...
AND ESTADO = 1";
$rs  = executeQuery($sql,$cnx);
$conversation_url1 = $rs['1']['DESCRIPCION'];
$conversation_url2 = $rs['1']['VALOR'];
//@@conversation_debito_url1 =$conversation_url1;
//@@conversation_debito_url2 =$conversation_url2;
@@conversation_debito_url =$conversation_url1;
